...
const AirChargerComponent = () => (
    <>
                <h1 className={pages.page_title}> AirCharger </h1>
                ...
                <img className={pages.page_video} src={aircharger8} alt="aircharger8"/>
                <p className={pages.page_description}>
                ...
                <img className={pages.page_video} src={aircharger7} alt="aircharger7"/>
                <video controls preload="auto" className={pages.page_video}>
                ...
                <img className={pages.page_video} src={aircharger3} alt="aircharger3"/>
                <p className={pages.page_description}>
                ...
                <img className={pages.page_video} src={aircharger2} alt="aircharger2"/>
                <p className={pages.page_description}>
...
export default AirChargerComponent
