                    ...
                    <TableBody style={{overflow: "visible"}}>
                        {this.state.rows.map((row) =>
                            <TableRow style={{overflow: "visible"}}>
                                ...
                                <TableCell className="one_world_deleteTable" align="right"><button onClick={this.deleteRow.bind(this, row.row_num)}><FontAwesomeIcon icon={faTrashAlt} id="delete_row_button"/></button></TableCell>
                            </TableRow>
                        )}
                    </TableBody>
                  </Table>
