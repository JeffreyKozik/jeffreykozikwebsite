                    ...
                    <TableBody>
                        {this.state.rows.map((row) =>
                            <TableRow>
                                ...
                                <TableCell class="one_world_consumptionTable" align="right">{this.generateConsumptionOptions}</TableCell>
                                <TableCell class="one_world_supplychainTable" align="right">{this.generateSupplyChainOptions}</TableCell>
