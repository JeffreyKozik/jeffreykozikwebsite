        ...
        <body>
            ...
            <div className="page_container">
                ...
                <p className="page_description">
                    ...
                    and only activate for a few seconds then go away. It's quite a contentious topic in the browser extension community and you can read more about it in the following links. The first one
                    talks about how this change from background scripts to service workers is an unfair move by Google because it makes it harder for Ad Blockers to work which is in Google's favor
                    because they run one of the biggest online ad networks in the world. It would be one thing if Google was upfront about this, but instead they claim it to be because of "security".
